...
function Step3Report({report}) {
    ...
    const downloadPDF = () => {
        ...
        // QUESTION TABLE with Blank Feedback Fix
        autoTable(doc, {
            startY: currentY,
            ...
            body: questionWiseScore.map((q, i) => [
                ...
                q.question || "N/A",
                `${q.score || 0}/10`,
                // Yahan fix hai: Agar feedback missing hai toh "You did not submit an answer" dikhayega
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8">
            <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <button onClick={downloadPDF} className="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-xl shadow-md font-semibold text-sm sm:text-base">
                    Download PDF
                </button>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                <div className="space-y-6">
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="bg-white rounded-3xl shadow-lg p-8 text-center">
                        <h3 className="text-gray-500 mb-6">Overall Performance</h3>
                        <div className='relative w-24 h-24 mx-auto'>
                            <CircularProgressbar value={percentage} text={`${finalScore}/10`} styles={buildStyles({ pathColor: "#10b981", textColor: "#ef4444" })} />
                        </div>
                        <div className="mt-4">
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className='bg-white rounded-3xl shadow-lg p-8'>
                        <h3 className="text-lg font-semibold text-gray-700 mb-6">Skill Evaluation</h3>
                ...
                <div className="lg:col-span-2 space-y-6">
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="bg-white rounded-3xl shadow-lg p-8">
                        <h3 className="text-lg font-semibold text-gray-700 mb-6">Performance Trend</h3>
                        <div className="h-72">
                    ...
                    <div className="bg-white rounded-3xl shadow-lg p-8">
                        <h3 className="text-lg font-semibold text-gray-700 mb-6">Question Breakdown</h3>
                        <div className="space-y-6">
                            {questionWiseScore.map((q, i) => (
                                <div key={i} className="bg-gray-50 p-6 rounded-2xl border border-gray-200">
                                    <div className="flex justify-between items-start mb-4">
                                        ...
                                        <div className="bg-green-100 text-green-600 px-3 py-1 rounded-full font-bold text-sm">
                                            {q.score ?? 0}/10
                                        </div>
                                    </div>
                                    <div className="bg-green-50 border border-green-200 p-4 rounded-lg">
                                        ...
                                        <p className="text-sm text-gray-700">
                                            {q.feedback && q.feedback.trim() !== "" ? q.feedback : "You did not submit an answer."}
                                        </p>
                                    </div>
                                </div>
                            ))}
